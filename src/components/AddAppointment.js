...
const AddAppointment = ({ onSendAppointment, lastId }) => {
    ...
    let [toggleForm, setToggleForm] = useState(false) //form should not be displaying by default
    //onClick -> change state of toggleForm from false to true 
    //if button is clicked we change the class of the button to make it sqaure instead of rounded
    ...
    function formDataPublish() {
        ...
        onSendAppointment(appointmentInfo); //sends apt info to list
        setFormData(clearData) // clears form input
        setToggleForm(!toggleForm)      //hides form on submit
    }
